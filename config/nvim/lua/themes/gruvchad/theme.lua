...
local c = require('themes.gruvchad.palette')
...
theme.set_highlights = function()
    ...
    hl(0, "NormalNC", { fg = c.base05, bg = 'NONE' })
    hl(0, "Pmenu", { fg = 'NONE', bg = 'NONE' })
    hl(0, "PmenuSel", { fg = c.white, bg = c.base02 })
    hl(0, "WildMenu", { fg = c.base08, bg = 'NONE' })
    hl(0, "CursorLineNr", { fg = c.white, bg = 'NONE' })
    hl(0, "Comment", { fg = c.grey_fg, bg = 'NONE' })
    hl(0, "Folded", { fg = c.base03, bg = 'NONE' })
    hl(0, "FoldColumn", { fg = c.base0C, bg = 'NONE' })
    ...
    hl(0, "VisualNOS", { fg = 'NONE', bg = c.base02 })
    ...
    hl(0, "QuickFixLine", { fg = 'NONE', bg = 'NONE', sp = 'NONE',  })
    hl(0, "PmenuSbar", { fg = 'NONE', bg = 'NONE' })
    hl(0, "PmenuThumb", { fg = 'NONE', bg = 'NONE' })
    hl(0, "MatchWord", { fg = c.white, bg = 'NONE' })
    hl(0, "MatchParen", { link = 'MatchWord' })
    hl(0, "Cursor", { fg = c.base00, bg = 'NONE' })
    ...
    hl(0, "ErrorMsg", { fg = c.base08, bg = 'NONE' })
    hl(0, "Search", { fg = c.base01, bg = 'NONE' })
    hl(0, "IncSearch", { fg = c.base01, bg = 'NONE' })
    hl(0, "Substitute", { fg = c.base01, bg = 'NONE', sp = 'NONE',  })
    ...
    hl(0, "Todo", { fg = c.base0A, bg = 'NONE' })
    hl(0, "Error", { fg = c.base00, bg = 'NONE' })
    hl(0, "TabLine", { fg = c.light_grey, bg = 'NONE' })
    hl(0, "TabLineSel", { fg = c.white, bg = 'NONE' })
    hl(0, "TabLineFill", { fg = c.line, bg = 'NONE' })
    ...
    hl(0, "LspReferenceRead", { fg = 'NONE', bg = 'NONE' })
    hl(0, "LspReferenceText", { fg = 'NONE', bg = 'NONE' })
    hl(0, "LspReferenceWrite", { fg = 'NONE', bg = 'NONE' })
    ...
    hl(0, "TelescopePreviewTitle", { fg = c.black, bg = 'NONE', bold=true, })
    hl(0, "TelescopePromptTitle", { fg = c.black, bg = 'NONE', bold=true, })
    hl(0, "TelescopeResultsTitle", { fg = c.darker_black, bg = 'NONE', bold=true, })
    hl(0, "TelescopeSelection", { fg = c.white, bg = 'NONE' })
    hl(0, "TelescopeBorder", { fg = c.darker_black, bg = 'NONE' })
    hl(0, "TelescopePromptBorder", { fg = c.black2, bg = 'NONE' })
    ...
    hl(0, "NvimTreeVertSplit", { fg = c.darker_black, bg = 'NONE' })
    ...
    -- Buffer
    hl(0, "BufferCurrent", { fg = c.base05, bg = 'NONE' })
    hl(0, "BufferCurrentIndex", { fg = c.base05, bg = 'NONE' })
    hl(0, "BufferCurrentMod", { fg = c.sun, bg = 'NONE' })
    hl(0, "BufferCurrentSign", { fg = c.purple, bg = 'NONE' })
    hl(0, "BufferCurrentTarget", { fg = c.red, bg = 'NONE', bold=true, })
    hl(0, "BufferVisible", { fg = c.base05, bg = 'NONE' })
    hl(0, "BufferVisibleIndex", { fg = c.base05, bg = 'NONE' })
    hl(0, "BufferVisibleMod", { fg = c.sun, bg = 'NONE' })
    hl(0, "BufferVisibleSign", { fg = c.grey, bg = 'NONE' })
    hl(0, "BufferVisibleTarget", { fg = c.red, bg = 'NONE', bold=true, })
    hl(0, "BufferInactive", { fg = c.grey, bg = 'NONE' })
    hl(0, "BufferInactiveIndex", { fg = c.grey, bg = 'NONE' })
    hl(0, "BufferInactiveMod", { fg = c.sun, bg = 'NONE' })
    hl(0, "BufferInactiveSign", { fg = c.grey, bg = 'NONE' })
    hl(0, "BufferInactiveTarget", { fg = c.red, bg = 'NONE', bold=true, })

    -- StatusLine
    hl(0, "StatusLine", { fg = c.line, bg = 'NONE' })
    ...
    -- Illuminate
    hl(0, "IlluminatedWordText", { fg = 'NONE', bg = 'NONE', sp = 'NONE',  })
end
