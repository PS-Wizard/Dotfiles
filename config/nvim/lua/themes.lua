...
local function set_highlights()
    ...
    hl(0, "FloatBorder", { fg = c.pmenu_bg, bg = 'NONE' })
    hl(0, "VertSplit", { fg = c.grey, bg = 'NONE' })
    hl(0, "WinSeparator", { fg = c.grey, bg = 'NONE' })
    ...
    -- BlinkCmp
    hl(0, "BlinkCmpDocBorder", { fg = c.pmenu_bg, bg = 'NONE' })
    hl(0, "BlinkCmpMenuBorder", { fg = c.pmenu_bg, bg = 'NONE' })
