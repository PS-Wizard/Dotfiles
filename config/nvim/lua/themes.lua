...
local function set_highlights()
  ...
  hl(0, "Pmenu", { fg = c.base05, bg = c.base00})
  hl(0, "PmenuSel", { fg = c.base05, bg = c.base01 })
  hl(0, "BlinkCmpMenu", { fg = c.base05, bg = 'NONE' })
  hl(0, "BlinkCmpMenuBorder", { fg = c.line, bg = 'NONE' })
  hl(0, "BlinkCmpMenuSelection", { fg = c.base05, bg = c.base01 })
  hl(0, "BlinkCmpDoc", { fg = c.base05, bg = 'NONE' })
  hl(0, "BlinkCmpDocBorder", { fg = c.line, bg = 'NONE' })
  hl(0, "BlinkCmpDocCursorLine", { fg = 'NONE', bg = c.base01 })
  hl(0, "MiniIndentscopeSymbol", { fg = c.grey_fg, bg = 'NONE' })
  hl(0, "MiniIndentscopeSymbolOff", { fg = c.grey, bg = 'NONE' })
  hl(0, "MiniPickNormal", { fg = c.base05, bg = 'NONE' })
  hl(0, "MiniPickBorder", { fg = c.line, bg = 'NONE' })
  hl(0, "MiniPickBorderBusy", { fg = c.line, bg = 'NONE' })
  hl(0, "MiniPickBorderText", { fg = c.base05, bg = 'NONE' })
  hl(0, "MiniPickPrompt", { fg = c.grey_fg, bg = 'NONE' })
  hl(0, "MiniPickPromptCaret", { fg = c.grey_fg2, bg = 'NONE' })
  hl(0, "MiniPickPromptPrefix", { fg = c.grey_fg2, bg = 'NONE' })
  hl(0, "MiniPickMatchCurrent", { fg = c.base05, bg = c.base01 })
  hl(0, "MiniPickMatchMarked", { fg = c.base05, bg = c.base02 })
  hl(0, "MiniPickMatchRanges", { fg = c.grey_fg2, bg = 'NONE' })
  hl(0, "MiniPickHeader", { fg = c.grey_fg2, bg = 'NONE' })
  hl(0, "MiniPickPreviewLine", { fg = 'NONE', bg = c.base01 })
  hl(0, "MiniPickPreviewRegion", { fg = c.base05, bg = c.base02 })
  hl(0, "FzfLuaTitle", { fg = c.base05, bg = 'NONE' })
  hl(0, "FzfLuaTitleFlags", { fg = c.base05, bg = c.base01 })
  hl(0, "FzfLuaHeaderBind", { fg = c.grey_fg2, bg = 'NONE' })
  hl(0, "FzfLuaHeaderText", { fg = c.grey_fg, bg = 'NONE' })
  hl(0, "WildMenu", { fg = c.base08, bg = c.base0A })
  hl(0, "CursorLineNr", { fg = c.white, bg = 'NONE' })
  hl(0, "Comment", { fg = "#6a7174", bg = 'NONE' })
